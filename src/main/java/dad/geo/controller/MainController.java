...
import javafx.scene.layout.BorderPane;
	...
	public class MainController implements Initializable{
	    ...
	    void OncheckIpAction(ActionEvent event) throws Exception {
			    	...
			    	locat.setCityPro(geoService.listBreeds(ip.getValue()).getCity().toString().concat("("
			    			.concat(geoService.listBreeds(ip.getValue()).getRegionName())+")"));
			    	...
			    	locat.setCurrencyPro(geoService.listBreeds(ip.getValue()).getCurrency().getName().concat("("
			    			.concat(geoService.listBreeds(ip.getValue()).getCurrency().getSymbol())+")"));
